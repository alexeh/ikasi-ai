  ...
  if (!document) {
    return (
      <div className="container py-8 text-center">
        ...
        <p className="text-muted-foreground">No se pudo encontrar el documento solicitado.</p>
        <Button asChild className="mt-4">
          <a href="/gaztelania/lectura">Volver al listado</a>
        </Button>
      </div>
    );
  }
    ...
    <div className="container py-8">
      ...
      {questions.length > 0 && (
        <div className="mt-8 space-y-6">
          <h2 className="text-2xl font-headline font-bold">Preguntas</h2>
